...
|--------|-----------|----------|----------|------|----------|
| 软件构建 | TODO | TODO：开发环境 / CI | 否 | TODO | TODO |
| 仿真/模拟器 | TODO | TODO：开发环境 / CI | 否 | TODO | TODO |
| 硬件 bring-up | TODO | TODO：硬件工作站 / self-hosted runner | 是 | TODO | TODO |
| 生产夹具测试 | TODO | TODO：产线环境 / self-hosted runner | 是 | TODO | TODO |
